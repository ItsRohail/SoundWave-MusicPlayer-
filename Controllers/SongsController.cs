...
public class SongsController : ControllerBase
{
    ...
    [HttpGet("search")]
    public IActionResult SearchSongs(string query)
    {
        ...
        var results = _context.Songs.Where(s => s.Name.Contains(query)).ToList();

        if (!results.Any())
        {
            return NotFound("No songs found matching the query.");
        }
